...
//              <a href="list.php?country=Canada" role="button" class="btn btn-default"> Canada</a>
              ...
              for ($i=0;$i<$length;$i++){
                  $country = $countries[$i];
                  echo '<a role="button" class="btn btn-default" href="list.php?country='.$country.'">'.$country.'</a>';
              }
              ?>
...
//          ksort($images);
//          for ($i=0;$i<$num;$i++){
//              $li = '<li><a href="detail.php?id='.$images[$i]['id'].'">'.'<img src="images/square'.$images[$i]['path'].'">';
//              $li .= '<div class="caption"><div class="blur"></div>'.'<div class="caption-text"><h1>'.$images[$i]['title'].'</h1></div></div></a></li>';
//              echo $li;
//          }

          foreach ($images as $value){
              $li = '<li><a href="detail.php?id='.$value['id'].'">'.'<img src="images/square/'.$value['path'].'">';
              $li .= '<div class="caption"><div class="blur"></div>'.'<div class="caption-text"><h1>'.$value['title'].'</h1></div></div></a></li>';
              echo $li;
          }
          ?>
